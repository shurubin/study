                    ...
                    <div className="content">
                        <div className="left">
                            <ul>
                                ...
                                <li>
                                    비회원 문의 : <a href="malito:help@kurlycorp.com">help@kurlycorp.com</a> <br />
                                    비회원 대량주문 문의 : <a href="malito:kurlygift@kurlycorp.com">kurlygift@kurlycorp.com</a> 
                                </li>
                            </ul>
                        </div>
                        <div className="right">
                            <ul>
                                ...
                                <li>
                                    ...
                                    입점문의 : <a href="https://accounts.google.com/">입점문의하기</a> <i>|</i> 제휴문의 : <a href="mailto:business@kurlycorp.com">business@kurlycorp.com</a><br />
                                    채용문의 : <a href="mailto:recruit@kurlycorp.com">recruit@kurlycorp.com</a><br />
                                    팩스: 070 - 7500 - 6098
                                </li>
                                <li>
                                    <a href="!#"><img src="./images/sign_up/ico_instagram.png" alt="" /></a>
                                    <a href="!#"><img src="./images/sign_up/ico_fb.png" alt="" /></a>
                                    <a href="!#"><img src="./images/sign_up/ico_blog.png" alt="" /></a>
                                    <a href="!#"><img src="./images/sign_up/ico_naverpost.png" alt="" /></a>
                                    <a href="!#"><img src="./images/sign_up/ico_youtube.png" alt="" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="row row2">
                <div className="container">
                    <div className="content">
                        <ul>
                            <li>
                                <img src="./images/sign_up/logo_isms.svg" alt="" />
                                <span>
                            ...
                            <li>
                                <img src="./images/sign_up/logo_privacy.svg" alt="" />
                                <span>
                                    개인정보보호 우수 웹사이트 ·<br />
                            ...
                            <li>
                                <img src="./images/sign_up/logo_tosspayments.svg" alt="" />
                                <span>
                                    토스페이먼츠 구매안전(에스크로)<br />
                                    서비스를 이용하실 수 있습니다.                                    
                                </span>
                            ...
                            <li>
                                <img src="./images/sign_up/logo_wooriBank.svg" alt="" />
                                <span>
