...
export default function SignUpComponent({회원가입, timer, timerCounterfn, mapAddressFn, addr, addressOpenPostcode}) {
                                            ...
                                            <div>
                                                ...
                                                <div className="center-box">
                                                    <button 
                                                        ...
                                                        onClick={onClickAddrPopupOpenApi}  
                                                        type='button'>주소검색</button>
                                                    <input onChange={onChangeAddr1} type='text' className={`${state.isAddress?'on':''}`} name='user_address1' id='userAddress1' placeholder='검색   주소1' />
                                                    <input onChange={onChangeAddr2} type='text' className={`${state.isAddress?'on':''}`} name='user_address2' id='userAddress2' placeholder='나머지 주소2' />
                                                    <h5>샛별배송</h5>
                                                ...
                                                className={`addr-research-btn on${state.isAddress?' on':''}`} type='button'>재검색</button>
