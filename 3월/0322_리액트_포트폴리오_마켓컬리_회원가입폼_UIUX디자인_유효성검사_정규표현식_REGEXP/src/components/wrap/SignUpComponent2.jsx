...
export default function SignUpComponent({회원가입, timer, timerCounterfn}) {
    ...
    React.useEffect(()=>{
        ...
        setState({
            ...state,            
            isConfirmModal: timer.isEnd,  // 모달 오픈 변수
            confirmMsg: timer.msg // 모달 메시지 변수
        })
                                                ...
                                                <li>
                                                    <div>                                               
                                                        <div className="center-box">
                                                            ...
                                                            />
                                                            <span className='hp-timer-counter'>{timer.minutes<10?`0${timer.minutes}`:timer.minutes}:{timer.seconds<10?`0${timer.seconds}`:timer.seconds}</span>
                                                        </div>
