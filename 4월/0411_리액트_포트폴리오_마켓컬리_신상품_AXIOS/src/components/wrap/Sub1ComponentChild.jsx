                ...
                <a href="!#">
                    ...
                    <div className="tit-box">
                        <ul>
                            ...
                            <li>{item.제품특성}</li>
                            <li><span className='rate-price'>{item.할인율*100===0? '':`${(item.할인율*100)}%`}</span><span className='panme-price'>{item.정가*(1-item.할인율)}</span></li>
                            ...
                            <a href="!#">
                                ...
                                <div className="tit-box">
                                    <ul>
                                        ...
                                        <li>{item.제품특성}</li>
                                        <li><span className='rate-price'>{`${item.할인율*100}%`} </span><span className='panme-price'>{item.정가*(1-item.할인율)}</span></li>
                                        <li><s>{item.정가}</s></li>
                                        <li>{item.판매처}</li>
                                    </ul>
                                </div>
