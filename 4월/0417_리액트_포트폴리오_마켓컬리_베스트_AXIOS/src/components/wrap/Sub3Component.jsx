                        ...
                        <div className="content">
                                    ...
                                    <div>
                                        ...
                                        <div className="sub">
                                            <ul>
                                                ...
                                                <li>
                                                    <label >
                                                        <input type="checkbox" name='category1_chk6' id='category1Chk6' value={'샐러드·간편식'} />
                                                        샐러드·간편식
                                                    </label>
                                                </li>
                                                <li>
                                        ...
                                        <div className="sub">
                                            <ul>
                                                <li>
                                                    <label >
                                                        <input type="checkbox" name='category3_chk1' id='category3Chk1' value={'샐러드·간편식'} />
                                                        샐러드·간편식
                                                    </label>
                                                </li>
                                                <li>
                                        ...
                                        <div className="sub">
                                            <ul>
                                                <li>
                                                    <label >
                                                        <input type="checkbox" name='category4_chk1' id='category4Chk1' value={'샐러드·간편식'} />
                                                        샐러드·간편식
                                                    </label>
                                                </li>
                                                <li>
                                        ...
                                        <div className="sub">
                                            <ul>
                                                <li>
                                                    <label >
                                                        <input type="checkbox" name='category5_chk1' id='category5Chk1' value={'샐러드·간편식'} />
                                                        샐러드·간편식
                                                    </label>
                                                </li>
                                                <li>
                            ...
                            <div className="right">
                                ...
                                <div className="right-content">
                                    ...
                                    <Sub3ComponentChild 알뜰상품={state.알뜰상품}/>
                                </div>
                            </div>
                        </div>
                    </div>
