<?
    ...
    $sql =  "INSERT INTO signup_table(id, pw, name, email, hp, addr, gender, birth, chooga, service, gaib_date)
            VALUES('ideass', 'password', '빵빵빵', '000@naver.com', '000-0000-0000', '인천시 서구 검암동 101번지', '여자', '2022-04-25', '마켓컬리 일일세일', '이용약관 동의필수 개인정보 수집∙이용 동의필수 본인은 만 14세 이상입니다.필수', '2023-03-16'),
