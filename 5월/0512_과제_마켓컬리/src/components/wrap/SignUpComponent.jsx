...
export default function SignUpComponent({회원가입, timer, timerCounterfn, mapAddressFn}) {
    ...
    const onSubmitSignupEvent=(e)=>{
        ...
        if(state.아이디중복확인===false){
            ...
            $.ajax({
                // url:'http://192.168.40.126:8080/jsp/0512_과제_마켓컬리_react연결/쇼핑몰고객관리/kurly_user_signup_action_para.jsp',                           
                // url:'http://192.168.40.126:8080/jsp/0512_과제_마켓컬리_react연결/쇼핑몰고객관리/kurly_user_signup_action_useBean.jsp',                           
                url:'http://192.168.40.126:8080/jsp/0512_과제_마켓컬리_react연결/쇼핑몰고객관리/kurly_user_signup_action.jsp',                           
                type:'POST',
                data:'formData',
                success(res){
                    console.log('AJAX 성공');
