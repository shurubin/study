...
// 더미데이터 입력
INSERT INTO signup_table(user_id, user_pw, user_name, user_email, user_hp, user_addr, user_gender, user_birth, user_chooga, user_service) 
VALUES('id','pw','name','email','hp','addr','gen','birth','chooga','service..');
