...
export default function TopModalComponent({topModalClose}) {
    ...
    const onClicktopModalClose=(e)=>{
        e.preventDefault();
        topModalClose('yes', 3); // Cookie Value = yes, Cookie expires
    }
