    ...
    return (
        <div id='wrap'>
                ...
                <BrowserRouter basename={process.env.PUBLIC_URL}>
                    <Routes>
                        <Route path='/' element={<HeaderComponent openPopupDaumPostApi={openPopupDaumPostApi} addr={addr} setIsIntroFn={setIsIntroFn} cartCount={cartCount} cartCountNumber={cartCountNumber} />}>                            
