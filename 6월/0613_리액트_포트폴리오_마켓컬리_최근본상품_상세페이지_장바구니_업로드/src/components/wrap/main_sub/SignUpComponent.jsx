...
export default function SignUpComponent({회원가입, openPopupDaumPostApi, addr, timer, timerCounterfn, mapAddressFn, confirmModalOpen}) {
    ...
    },[addr.주소1,addr.주소2, addr.isAddr, state.주소1, state.주소2, state.isAddress, state]);
