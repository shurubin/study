    ...
    return (
        <div id='wrap'>
                ...
                <BrowserRouter basename={process.env.PUBLIC_URL}>
                    <Routes>
                        <Route path='/' element={<HeaderComponent setIsIntroFn={setIsIntroFn} mapText={state.mapText} isMap={state.isMap} cartCount={cartCount} cartCountNumber={cartCountNumber} />}>                            
