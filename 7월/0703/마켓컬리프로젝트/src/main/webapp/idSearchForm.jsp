	...
	<div class='container'>
		...
		<div class="content">
		    <form name="idSearchForm" autocomplete="off" id="idSearchForm" method="post" action="./idSearchAction.jsp">
		        <ul>
		            <li><input  maxlength="16" type="text" name="user_name" id="user_name" placeholder="이름을 입력하세요"></li>
		            <li><input maxlength="16" type="text" name="user_hp" id="user_hp" placeholder="전화번호를 입력하세요"></li>
		        </ul>
