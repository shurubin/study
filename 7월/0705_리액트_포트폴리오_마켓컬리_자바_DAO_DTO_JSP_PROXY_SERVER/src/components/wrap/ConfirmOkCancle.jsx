...
export default function ConfirmOkCancle(){

    const {ConfirmModalOkCancleClose, confirmMsgOkCancel} = React.useContext(ConfirmContext);


    const onClickConfirmModalClose=(e, value)=>{
        e.preventDefault();
        ConfirmModalOkCancleClose(value);        
    }
