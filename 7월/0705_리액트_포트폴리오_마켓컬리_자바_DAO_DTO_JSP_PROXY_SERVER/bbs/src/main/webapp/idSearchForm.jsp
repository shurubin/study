	...
	<div class='container'>
		...
		<div class="content">
		    <form name="idSearchForm" autocomplete="off" id="idSearchForm" method="post" action="./idSearchAction.jsp">
		        <ul>
		            <li><input  maxlength="16" type="text" name="userName" id="userName" placeholder="이름을 입력하세요"></li>
		            <li><input maxlength="16" type="text" name="userEmail" id="userEmail" placeholder="이메일을 입력하세요"></li>
		        </ul>
