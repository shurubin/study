	...
	<div class='container'>
		...
		<div class="content">
		    <form name="pwSearchForm" autocomplete="off" id="pwSearchForm" method="post" action="./pwSearchAction.jsp">
		        <ul>
		            <li><input  maxlength="16" type="text" name="user_id" id="user_id" placeholder="아이디를 입력하세요"></li>
		            <li><input maxlength="100" type="text" name="user_hp" id="user_hp" placeholder="이메일을 입력하세요"></li>
		        </ul>
