...
{"아이디":"<%= userDTO.getUser_id() %>", "비밀번호":"<%= userDTO.getUser_pw() %>",    "이름":"<%= userDTO.getUser_name() %>",    "이메일":"<%= userDTO.getUser_email() %>",    "연락처":"<%= userDTO.getUser_hp() %>",    "주소":"<%= userDTO.getUser_addr() %>",    "성별":"<%= userDTO.getUser_gender() %>",    "생일":"<%= userDTO.getUser_birth() %>",    "가입경로":"<%= userDTO.getUser_chooga() %>",    "이용약관동의":"<%= userDTO.getUser_service() %>"}
